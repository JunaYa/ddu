  ...
  shortcuts: [
    {
      ...
      // buttons
      'btn-base': 'cursor-pointer relative disabled:pointer-events-none disabled:bg-$c-bg-btn-disabled disabled:text-$c-text-btn-disabled border-none appearance-none focus:outline-none',
      'btn-solid': 'btn-base px-4 py-2 rounded text-inverted bg-$c-primary hover:bg-$c-primary-active active:bg-$c-primary-active active:scale-98',
